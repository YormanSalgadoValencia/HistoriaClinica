...
const plantillas = reactive<Plantilla[]>([
    {
        ...
        description:
            'Registro detallado de la información básica del paciente, incluyendo sus datos personales y de contacto. Permite almacenar información esencial para la identificación y comunicación con el paciente, asegurando un acceso rápido y organizado a estos datos en cualquier momento.',
    ...
    },
    {
        ...
        description:
            'Formulario estructurado para recopilar datos clínicos iniciales de un paciente. Contiene información clave sobre signos vitales y síntomas, lo que facilita una evaluación rápida y eficiente para el diagnóstico y tratamiento médico.',
    ...
    },
    {
        ...
        description:
            'Documento detallado que recoge información sobre los antecedentes médicos del paciente, incluyendo enfermedades crónicas, alergias, cirugías previas y medicación actual. Es fundamental para un seguimiento adecuado de la salud del paciente y la toma de decisiones médicas informadas.',
    ...
    },
    {
        ...
        description:
            'Registro diseñado para situaciones de emergencia, proporcionando información crítica sobre el paciente, como su grupo sanguíneo, alergias importantes y contactos de emergencia. Facilita una respuesta rápida y efectiva en casos donde cada segundo cuenta.',
        categories: ['Tercera'],
        sections: [
            {
                id: crypto.randomUUID(),
...
const searchPlantilla = computed(() => plantillas.filter((p) => p.name.toLowerCase().includes(plantillaBuscada.value.toLowerCase())));
...
const searchPlantillaByCategory = computed(() => plantillas.filter((p) => p.categories?.includes(selectedCategory.value)));
...
<template>
    <v-container>
        <v-row>
            <v-col cols="12">
                <PlantillaCard :plantilla="plantillEnBlanco" @click="openPlantilla(plantillEnBlanco)" />
            </v-col>
        </v-row>
        <v-row>
            <v-col cols="9">
            ...
            <v-col cols="3">
                <v-btn color="primary" @click="isOpenModalCrear = true"> Crear Plantilla </v-btn>
            </v-col>
        </v-row>
        ...
        <v-row>
            ...
            <div v-else class="template-list">
                <PlantillaCard v-for="plantilla in plantillas" :plantilla="plantilla" @click="openPlantilla(plantilla)" />
            </div>
        </v-row>
